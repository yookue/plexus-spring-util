...
public abstract class AnnotationUtilsWraps {
    ...
    /**
     * Returns a {@link cn.unikue.commonplexus.javaseutil.structure.BooleanDataStruct} that contains all the annotations, on the given method or the method owner class
     * <p>
     ...
     * @param annotations The annotations to check
     *
     * @return a {@link cn.unikue.commonplexus.javaseutil.structure.BooleanDataStruct} that contains all the annotations, on the given method or the method owner class
     */
    @Nonnull
    ...
    /**
     * Returns a {@link cn.unikue.commonplexus.javaseutil.structure.BooleanDataStruct} that contains any of the annotations, on the given method or the method owner class
     * <p>
     * With annotation class as keys, {@link java.lang.annotation.ElementType} as values
     *
     * @param method The method to get annotations from
     * @param annotations The annotations to check
     *
     * @return a {@link cn.unikue.commonplexus.javaseutil.structure.BooleanDataStruct} that contains any of the annotations, on the given method or the method owner class
     */
    @Nonnull
