...
import cn.unikue.commonplexus.javaseutil.util.FieldUtilsWraps;
import cn.unikue.commonplexus.javaseutil.util.ObjectUtilsWraps;
import cn.unikue.commonplexus.springutil.enumeration.JsonParserType;
...
public abstract class JsonParserWraps {
     ...
     *
     * @param content The string representation of json
     * @param parser The json parser instance, should be in the {@link cn.unikue.commonplexus.springutil.enumeration.JsonParserType}
     *
