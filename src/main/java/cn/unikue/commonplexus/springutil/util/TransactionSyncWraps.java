...
public abstract class TransactionSyncWraps {
     ...
     *
     * @param callback The callback function to be triggered, the generic type source is {@link cn.unikue.commonplexus.springutil.enumeration.TransactionStatusType}
     * 
     * @see org.springframework.transaction.support.TransactionSynchronization#afterCompletion
     * @see cn.unikue.commonplexus.springutil.enumeration.TransactionStatusType
     */
