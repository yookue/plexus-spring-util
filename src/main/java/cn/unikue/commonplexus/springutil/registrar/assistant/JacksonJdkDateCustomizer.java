...
package cn.unikue.commonplexus.springutil.registrar.assistant;
...
import cn.unikue.commonplexus.springutil.jackson.deserializer.JdkDateDeserializer;
...
public abstract class JacksonJdkDateCustomizer {
    ...
    public static SimpleModule mapperModule(@Nullable String dateFormat) {
        ...
        result.addSerializer(java.sql.Date.class, new cn.unikue.commonplexus.springutil.jackson.serializer.SqlDateSerializer(false, new SimpleDateFormat(dateFormat)));
        result.addDeserializer(java.util.Date.class, new JdkDateDeserializer());
        result.addDeserializer(java.sql.Date.class, new cn.unikue.commonplexus.springutil.jackson.deserializer.SqlDateDeserializer());
        return result;
    }
