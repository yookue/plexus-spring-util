...
import cn.unikue.commonplexus.javaseutil.util.ConstructorUtilsWraps;
import cn.unikue.commonplexus.springutil.event.PropertiesCapableEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureAmbiguousEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureBadCredentialsEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureCredentialsExpiredEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureDisabledEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureExpiredEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureLockedEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureProviderNotFoundEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureProxyUntrustedEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationFailureServiceExceptionEvent;
import cn.unikue.commonplexus.springutil.security.event.PropertiesAuthenticationSuccessEvent;
import cn.unikue.commonplexus.springutil.security.exception.BadCaptchaException;
