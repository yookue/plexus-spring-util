...
import cn.unikue.commonplexus.springutil.registrar.ServerInitializedListenerRegistrar;
 ...
 * @see cn.unikue.commonplexus.springutil.registrar.ServerInitializedListenerRegistrar
 */
@Target(value = ElementType.TYPE)
@Retention(value = RetentionPolicy.RUNTIME)
@Documented
@Configuration(proxyBeanMethods = false)
@Import(value = ServerInitializedListenerRegistrar.class)
@SuppressWarnings("unused")
public @interface EnableServerInitializedListener {
    /**
