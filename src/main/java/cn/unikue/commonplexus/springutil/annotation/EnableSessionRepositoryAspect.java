...
import cn.unikue.commonplexus.springutil.registrar.SessionRepositoryAspectRegistrar;


/**
 * Annotation for enables a {@link cn.unikue.commonplexus.springutil.aspect.SessionRepositoryAspect}
 *
 * @author David Hsing
 */
...
public @interface EnableSessionRepositoryAspect {
    /**
     * Returns whether to fire a {@link cn.unikue.commonplexus.springutil.event.HttpSessionSavedEvent} only on attribute changes
     *
     * @return whether to fire a {@link cn.unikue.commonplexus.springutil.event.HttpSessionSavedEvent} only on attribute changes
     */
