...
/**
 * {@link com.fasterxml.jackson.databind.JsonSerializer} for serializing {@link java.lang.Boolean} to {@link java.lang.String} with values "y/n"
 * <p>
 * Usage: annotates on bean properties<br/>
 * <pre><code>
 *     {@literal @}JsonSerialize(using = Boolean2YNSerializer.class)
 * </code></pre>
 *
 * @author David Hsing
 *
...
public class BooleanToYNSerializer extends JsonSerializer<Boolean> {
    ...
    public void serialize(@Nullable Boolean value, @Nonnull JsonGenerator generator, @Nullable SerializerProvider provider) throws IOException {
        generator.writeString(BooleanUtilsWraps.toStringYN(value, uppercase));
    }
}
