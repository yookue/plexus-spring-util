...
/**
 * Event when the jwt authentication been refreshed
 *
 * @author David Hsing
 *
...
public class JwtAuthenticationRefreshedEvent extends ApplicationEvent {
    public JwtAuthenticationRefreshedEvent(@Nonnull Authentication authentication) {
