...
/**
 * Timestamp job parameters incrementer
 *
 * @author David Hsing
 *
...
public class TimestampJobParametersIncrementer implements JobParametersIncrementer {
    private String key = "run.timestamp";
    ...
    public JobParameters getNext(@Nullable JobParameters parameters) {
        ...
        return new JobParametersBuilder(params).addLong(this.key, System.currentTimeMillis()).toJobParameters();
    }
}
